  ...
  \resumeSubHeadingListStart
    \resumeSubheading
      ...
      {工商管理學系}{}
    	...
    	\resumeItem{\textbf{核心修課}：WebAPP 開發、文字探勘初論、資料庫管理、程式設計（C++, Python）、互動設計、數位美學。}
        \resumeItemListEnd
    ...
    \resumeSubHeadingListStart
      ...
      \resumeProjectHeading
         {\textbf{AI 股票投資決策支援網頁平台} $|$ \emph{React, Vite, Tailwind CSS, Python}}{2026年3月 -- 目前}
          \resumeItemListStart
            \resumeItem{參與小組團隊開發，打造提供即時股市分析與 AI 驅動投資策略建議的全端決策支援平台。}
            \resumeItem{負責撰寫完整的系統需求規格書並擬定數據導向的風險管理計劃，確保系統架構的穩定性與範疇一致。}
          \resumeItemListEnd
